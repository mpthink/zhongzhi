...
function getRow(g, h) {
    var i = "<tr align='center' id='row_" + g + "'>" +
        ...
        "<td align='center'><input type='text' name='oss_prodname[]' id='oss_prodname_" + g + "' size='40' onfocus='clearTip(this)'  onblur='fillTip(this)' value='请输入关键字或空格' style='color:#CCC'/></td>" +
        "<td align='center'><input type='text' id='oss_cate_name_" + g + "' size='10' disabled/></td>" +
        ...
        "<td align='center'>" + "<select name='oss_store[]' id='oss_store_" + g + "' >" + "<option value=''>--请选择--</option>" + "</select>" + "</td>" +
