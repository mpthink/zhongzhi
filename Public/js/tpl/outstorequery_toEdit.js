...
function getRow(g, h) {
    var i = "<tr id='row_" + g + "'>" +
        ...
        "<td align='center'><input name='oss_prodname[]' index='" + g + "' type='text' id='oss_prodname_" + g + "' size='40' value='请输入关键字或空格' onfocus='clearTip(this)' onblur='fillTip(this)' style='color:#CCC'/></td>" +
