...
class IndexAction extends AppAction{
    ...
    public function main(){
        ...
        $instore_month=$model_insub->alias('a')->join('twms_instore_main b on a.iss_mainid	=b.ism_id')->where("ism_status_time>'$this_month_start' and ism_status_time<'$this_month_end' and b.ism_status>0")->field("sum(iss_count) as count,sum(iss_total) as total")->find();
        ...
        $instore_count=$model_insub->alias('a')->join('twms_instore_main b on a.iss_mainid	=b.ism_id')->where("b.ism_status>0")->field("sum(iss_count) as count,sum(iss_total) as total")->find();
        ...
        $instore_toady_count=$model_insub->alias('a')->join('twms_instore_main b on a.iss_mainid	=b.ism_id')->where("ism_status_time>'$today_start' and ism_status_time<'$today_end' and b.ism_status>0")->field("sum(iss_count) as count,sum(iss_total) as total")->find();
        ...
        $instore_count_date_re_6=$model_insub->alias('a')->join('twms_instore_main b on a.iss_mainid	=b.ism_id')->where("b.ism_status>0 and ism_status_time>='$date_re_6 00:00:00' and ism_status_time<='$date_re_6 59:59:59'")->field("sum(iss_count) as count,sum(iss_total) as total")->find();
        $instore_count_date_re_5=$model_insub->alias('a')->join('twms_instore_main b on a.iss_mainid	=b.ism_id')->where("b.ism_status>0 and ism_status_time>='$date_re_5 00:00:00' and ism_status_time<='$date_re_5 59:59:59'")->field("sum(iss_count) as count,sum(iss_total) as total")->find();
        $instore_count_date_re_4=$model_insub->alias('a')->join('twms_instore_main b on a.iss_mainid	=b.ism_id')->where("b.ism_status>0 and ism_status_time>='$date_re_4 00:00:00' and ism_status_time<='$date_re_4 59:59:59'")->field("sum(iss_count) as count,sum(iss_total) as total")->find();
        $instore_count_date_re_3=$model_insub->alias('a')->join('twms_instore_main b on a.iss_mainid	=b.ism_id')->where("b.ism_status>0 and ism_status_time>='$date_re_3 00:00:00' and ism_status_time<='$date_re_3 59:59:59'")->field("sum(iss_count) as count,sum(iss_total) as total")->find();
        $instore_count_date_re_2=$model_insub->alias('a')->join('twms_instore_main b on a.iss_mainid	=b.ism_id')->where("b.ism_status>0 and ism_status_time>='$date_re_2 00:00:00' and ism_status_time<='$date_re_2 59:59:59'")->field("sum(iss_count) as count,sum(iss_total) as total")->find();
        $instore_count_date_re_1=$model_insub->alias('a')->join('twms_instore_main b on a.iss_mainid	=b.ism_id')->where("b.ism_status>0 and ism_status_time>='$date_re_1 00:00:00' and ism_status_time<='$date_re_1 59:59:59'")->field("sum(iss_count) as count,sum(iss_total) as total")->find();
        $instore_count_date_doday=$model_insub->alias('a')->join('twms_instore_main b on a.iss_mainid	=b.ism_id')->where("b.ism_status>0 and ism_status_time>='$date_today 00:00:00' and ism_status_time<='$date_today 59:59:59'")->field("sum(iss_count) as count,sum(iss_total) as total")->find();
